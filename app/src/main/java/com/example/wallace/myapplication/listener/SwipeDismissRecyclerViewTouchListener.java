package com.example.wallace.myapplication.listener;
...
public class SwipeDismissRecyclerViewTouchListener implements View.OnTouchListener {
    ...
    //缓存ViewConfiguration和系统范围的常量值
    private int mSlop;
    private int mMinFlingVelocity; // 抛的速度
    private int mMaxFlingVelocity;
    private long mAnimationTime;  //动画时间

    // Fixed properties 固定属性
    ...
    public boolean onTouch(View view, MotionEvent motionEvent) {
        ...
        switch (motionEvent.getActionMasked()) {
            ...
            case MotionEvent.ACTION_CANCEL: {//表示取消手势，不会由用户产生，而是由程序产生的
            ...
            case MotionEvent.ACTION_UP: {
                if (!mSwiping && mDownView != null && mItemTouchCallback != null) {
                    ...
                    mItemTouchCallback.onTouch(mRecyclerView.getChildAdapterPosition(mDownView));
                    mVelocityTracker.recycle();
                    mVelocityTracker = null;
                    mDownX = 0;
                    mDownY = 0;
